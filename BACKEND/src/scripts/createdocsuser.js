...
async function createDevUser() {
  try {
    ...
    const email = 'docs@fluxi.com';
    const plainPassword = 'fluxidocs1234*';
    const hashedPassword = await bcrypt.hash(plainPassword, 12);

    const roleCode = 'fluxiDocs';

    console.log('Creando usuario DOCS...');
    ...
    console.log('Usuario DOCS creado correctamente');
    ...
    console.error('Error creando usuario DOCS:', error.message);
    process.exit(1);
  }
}
